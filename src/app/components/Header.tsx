            ...
            <div className="container px-3 mx-auto py-0 md:py-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <a
                        ...
                        className="bg-primary hover:bg-secondary text-white px-5 py-2.5 text-lg rounded-lg hidden sm:flex items-center transition-all shadow-md whitespace-nowrap sm:whitespace-normal"
                    >
                        <svg
                    ...
                    <a
                        ...
                        className="bg-[#25D366] hover:bg-[#1DA851] text-white px-5 py-2.5 text-lg rounded-lg hidden sm:flex items-center transition-all shadow-md whitespace-nowrap sm:whitespace-normal"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 mr-2"
                ...
                <nav className="flex justify-end mx-auto px-4 py-3">
                    <div className="inline-block">
                        ...
                        <div className="mt-4 flex flex-col gap-3 items-end">
                            <a
                                href="tel:+525555555555"
                                className="bg-primary hover:bg-secondary text-white px-5 py-2.5 text-lg rounded-lg flex items-center transition-all whitespace-nowrap sm:whitespace-normal"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 mr-2"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-[#25D366] hover:bg-[#1DA851] text-white px-5 py-2.5 text-lg rounded-lg flex items-center transition-all whitespace-nowrap sm:whitespace-normal"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 mr-2"
